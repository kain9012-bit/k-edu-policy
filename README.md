...
정보공개포털의 **결재문서 목록**과 **지방교육재정 세출예산**을 함께 살펴보는 서비스입니다.
...
3. **결재문서** — 정보공개포털 정보목록·원문정보. 문서번호·담당부서 확인, 정보공개청구 안내.
...
5. **수집 출처** — 첫 화면은 **공개 수준 비교**. 교육청별로 홈페이지에 공개한 계획서 수와
   결재문서로만 남은 계획 수를 나란히 놓아 공개율을 보여준다. 그 뒤로 교육청별·게시판별
...
data/
  ...
  infolist.json                정보공개포털 결재문서 정보목록 (20MB)
...
- [x] 세출예산 검색·비교
- [x] 정보공개포털 결재문서 정보목록 수집
- [x] 공개 수준 비교(홈페이지 공개분 vs 결재문서)
