  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      >
        ...
        {/* 아랫줄: 필터 */}
        <div className="pt-3 border-t border-blue-200 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
          <div>
            <label className="block text-xs font-bold text-slate-500 mb-1">교육청</label>
            <select
              value={selectedOffice}
              onChange={(e) => setSelectedOffice(e.target.value)}
              className="w-full text-xs bg-white border border-slate-300 rounded-md p-2 font-medium text-slate-800"
            >
          ...
          <div>
            <label className="block text-xs font-bold text-slate-500 mb-1">생산 연도</label>
            <select
              value={selectedYear}
          ...
          <div>
            <label className="block text-xs font-bold text-slate-500 mb-1">담당부서</label>
            <select
              value={selectedDept}
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full text-xs bg-white hover:bg-slate-100 text-slate-700 font-bold py-2 px-3
                         rounded-md border border-slate-300 flex items-center justify-center gap-1.5"
            >
