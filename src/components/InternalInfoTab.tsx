        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          ...
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white text-slate-900 placeholder-slate-400 text-base rounded-md border border-slate-300 focus:border-blue-600 transition-colors outline-none"
            />
          </div>
          ...
          <div className="w-full sm:w-48">
            <select
              ...
              className="w-full text-xs bg-white border border-slate-300 rounded-md p-2.5 font-medium text-slate-800 focus:ring-1 focus:ring-emerald-500"
            >
